...
| COMPLETED project entries blocked | Project status check before entry creation |
...
| `timesheetSlice` | `features/timesheets/timesheetSlice.js` | Redux state: current timesheet, list, loading |
...
- Copy last week's entries as template
