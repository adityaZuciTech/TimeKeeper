...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Timesheet ts1 = timesheetRepository.save(Timesheet.builder()
                ...
                .weekEndDate(LocalDate.of(2026, 2, 15))
                .status(Timesheet.TimesheetStatus.SUBMITTED)
                .createdAt(LocalDateTime.of(2026, 2, 9, 9, 0))
                .build());
        ...
        Timesheet ts2 = timesheetRepository.save(Timesheet.builder()
                ...
                .status(Timesheet.TimesheetStatus.SUBMITTED)
                .createdAt(LocalDateTime.of(2026, 2, 16, 9, 0))
                .build());
        ...
        Timesheet ts3 = timesheetRepository.save(Timesheet.builder()
                ...
                .weekEndDate(LocalDate.of(2026, 3, 8))
                .status(Timesheet.TimesheetStatus.SUBMITTED)
                .createdAt(LocalDateTime.of(2026, 3, 2, 9, 0))
                .build());
        ...
        Timesheet ts4 = timesheetRepository.save(Timesheet.builder()
                ...
                .status(Timesheet.TimesheetStatus.SUBMITTED)
                .createdAt(LocalDateTime.of(2026, 3, 9, 9, 0))
                .build());
        ...
        // Timesheet 5 – John, week Mar 09 (DRAFT - current working week)
